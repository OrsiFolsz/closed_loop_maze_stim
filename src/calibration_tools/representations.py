...
# %% Global Variables
with open('C:/Users/Behre/Documents/LED_API/m25_maze_config.json') as input_file:
    MAZE_CONFIGS = json.load(input_file)

with open('C:/Users/Behre/Documents/LED_API/maze_measurements.json') as input_file:
